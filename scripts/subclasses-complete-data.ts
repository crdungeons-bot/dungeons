...
// TODO: Add remaining 42 subclasses:
// - 9 Rogue Archetypes (Thief, Assassin, Arcane Trickster, Inquisitive, Mastermind, Scout, Swashbuckler, Phantom, Soulknife)
// - 10 Sorcerer Origins (Draconic, Wild Magic, Divine Soul, Shadow Magic, Storm, Aberrant Mind, Clockwork Soul, Lunar, Phoenix, Stone)
// - 9 Warlock Patrons (Archfey, Fiend, Great Old One, Celestial, Hexblade, Fathomless, Genie, Undead, Undying)
// - 14 Wizard Schools (Abjuration, Conjuration, Divination, Enchantment, Evocation, Illusion, Necromancy, Transmutation, Bladesinging, Chronurgy, Graviturgy, Order of Scribes, War Magic, Onomancy)
