export type SpellEntry = {
    ...
    // shared
    classes?:      string[];
    subclasses?:   string[]; // subclasses that grant/expand this spell (e.g., ["forge domain cleric", "hexblade warlock"])
    actionType:    string;
    description:   string;
};

const SPELLS_AND_ABILITIES: SpellEntry[] = [
	{
		"name": "Acid Splash",
		"level": 0,
		"school": "evocation",
	...
	},
	{
		...
		"components": ["v", "s"],
		"duration": "Instantaneous",
		"description": "**Weather Sensor.** You create a Tiny, harmless sensory effect that predicts what the weather will be at your location for the next 24 hours. The effect might manifest as a golden orb for clear skies, a cloud for rain, falling snowflakes for snow, and so on. This effect persists for 1 round. \n\n**Bloom.** You instantly make a flower blossom, a seed pod open, or a leaf bud bloom. \n\n**Sensory Effect.** You create a harmless sensory effect, such as falling leaves, spectral dancing fairies, a gentle breeze, the sound of an animal, or the faint odor of skunk. The effect must fit in a 5-foot Cube. \n\n**Fire Play.** You light or snuff out a candle, a torch, or a campfire."
	},
	{
		"name": "Eldritch Blast",
		"level": 0,
	...
	},
	{
		...
		"school": "abjuration",
		"classes": ["warlock"],
		"subclasses": ["oath of conquest paladin"],
		"actionType": "Bonus Action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
		...
		"duration": "1 hour",
		"description": "A protective magical frost surrounds you. You gain 5 temporary hit points for the duration. If a creature hits you with a melee attack while you have these hit points, the creature takes 5 cold damage.",
		"higherLevelSlot": "Both the temporary hit points and the cold damage increase by 5 for each slot level above 1st."
	},
	{
		"name": "Bane",
		"level": 1,
		...
		"subclasses": ["grave domain cleric","oath of vengeance paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "30 feet",
	...
	},
	{
		...
		"subclasses": ["fiend warlock","light domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"subclasses": ["trickery domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "30 feet",
	...
	},
	{
		...
		"subclasses": ["fiend warlock","knowledge domain cleric","oath of conquest paladin"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"subclasses": ["celestial warlock","life domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"subclasses": ["archfey warlock","light domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"school": "necromancy",
		"classes": ["artificer", "sorcerer", "wizard"],
		"subclasses": ["grave domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"subclasses": ["tempest domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "120 feet",
	...
	},
	{
		...
		"subclasses": ["forge domain cleric","knowledge domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": true,
		"castingTime": "1 minute",
	...
	},
	{
		...
		"subclasses": ["oath of devotion paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"subclasses": ["oath of devotion paladin","oath of redemption paladin"],
		"actionType": "Bonus Action",
		"concentration": false,
		"ritual": false,
		"range": "30 feet",
	...
	},
	{
		...
		"school": "enchantment",
		"classes": ["bard", "sorcerer", "wizard"],
		"subclasses": ["archfey warlock","oath of redemption paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"subclasses": ["nature domain cleric","oath of the ancients paladin"],
		"actionType": "action",
		"concentration": false,
		"ritual": true,
		"range": "Self",
	...
	},
	{
		...
		"duration": "up to 1 minute",
		"description": "One creature of your choice that you can see within range makes a Wisdom saving throw. On a failed save, it has the Prone and Incapacitated conditions for the duration. During that time, it laughs uncontrollably if it's capable of laughter, and it can't end the Prone condition on it self. \n\nAt the end of each of its turns and each time it takes damage, it makes another Wisdom saving throw. The target has Advantage on the save if the save is triggered by damage. On a successful save, the spell ends.",
	...
	},
	{
		...
		"subclasses": ["tempest domain cleric", "armorer artificer", "artillerist artificer"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"subclasses": ["knowledge domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": true,
		"castingTime": "1 minute",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["druid", "ranger"],
		"subclasses": ["circle of the land (forest) druid","nature domain cleric"],
		"actionType": "Bonus Action",
		"concentration": false,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "illusion",
		"classes": ["artificer", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (desert) druid","hexblade warlock"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"school": "evocation",
		"classes": ["sorcerer", "warlock", "wizard"],
		"subclasses": ["circle of the land (swamp) druid"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"school": "conjuration",
		"classes": ["druid", "sorcerer", "wizard"],
		"subclasses": ["celestial warlock","light domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"subclasses": ["circle of the land (arctic) druid","oath of conquest paladin","oath of redemption paladin","oath of vengeance paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"school": "illusion",
		"classes": ["artificer", "bard", "sorcerer", "warlock", "wizard"],
		"subclasses": ["circle of the land (grassland) druid"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "abjuration",
		"classes": ["artificer", "bard", "cleric", "druid", "paladin", "ranger"],
		"subclasses": ["celestial warlock","life domain cleric","oath of devotion paladin"],
		"actionType": "Bonus Action",
		"concentration": false,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"subclasses": ["forge domain cleric","war domain cleric"],
		"actionType": "Bonus Action",
		"concentration": false,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "illusion",
		"classes": ["bard", "sorcerer", "warlock", "wizard"],
		"subclasses": ["circle of the land (coast) druid","trickery domain cleric","armorer artificer"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"school": "conjuration",
		"classes": ["sorcerer", "warlock", "wizard"],
		"subclasses": ["circle of the land (coast) druid","oath of the ancients paladin","oath of vengeance paladin"],
		"actionType": "Bonus Action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"school": "abjuration",
		"classes": ["druid", "ranger"],
		"subclasses": ["circle of the land (grassland) druid","trickery domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"school": "evocation",
		"classes": ["bard", "sorcerer", "wizard"],
		"subclasses": ["tempest domain cleric","armorer artificer"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"subclasses": ["circle of the land (desert) druid"],
		"actionType": "action",
		"concentration": true,
		"ritual": true,
		"range": "120 feet",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["artificer", "sorcerer", "warlock", "wizard"],
		"subclasses": ["circle of the land (forest) druid","circle of the land (mountain) druid"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["druid", "ranger"],
		"subclasses": ["circle of the land (arctic) druid","circle of the land (mountain) druid","nature domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "150 feet",
	...
	},
	{
		...
		"school": "evocation",
		"classes": ["cleric"],
		"subclasses": ["life domain cleric","oath of conquest paladin","war domain cleric"],
		"actionType": "Bonus Action",
		"concentration": true,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"school": "abjuration",
		"classes": ["cleric"],
		"subclasses": ["life domain cleric","oath of devotion paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "30 feet",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["artificer", "sorcerer", "wizard"],
		"subclasses": ["archfey warlock","hexblade warlock","trickery domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"school": "conjuration",
		"classes": ["druid"],
		"subclasses": ["circle of the land (forest) druid","tempest domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "120 feet",
	...
	},
	{
		...
		"school": "abjuration",
		"classes": ["sorcerer", "warlock", "wizard"],
		"subclasses": ["oath of redemption paladin"],
		"actionType": "reaction",
		"concentration": false,
		"ritual": false,
		"castingTrigger": "which you take when you see a creature within 60 feet of yourself casting a spell with Verbal, Somatic, or Material components",
		"range": "60 feet",
		"components": ["s"],
		"duration": "Instantaneous",
	...
	},
	{
		...
		"subclasses": ["celestial warlock","circle of the land (grassland) druid","light domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "60 feet",
	...
	},
	{
		...
		"subclasses": ["oath of devotion paladin","trickery domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "120 feet",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["artificer", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (grassland) druid","oath of vengeance paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "30 feet",
	...
	},
	{
		...
		"school": "illusion",
		"classes": ["bard", "sorcerer", "warlock", "wizard"],
		"subclasses": ["oath of redemption paladin","armorer artificer"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "120 feet",
	...
	},
	{
		...
		"school": "evocation",
		"classes": ["sorcerer", "wizard"],
		"subclasses": ["circle of the land (mountain) druid","armorer artificer"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["cleric", "druid", "ranger"],
		"subclasses": ["circle of the land (mountain) druid"],
		"actionType": "action",
		"concentration": false,
		"ritual": true,
		"range": "Touch",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["bard", "druid", "ranger"],
		"subclasses": ["archfey warlock","circle of the land (forest) druid","nature domain cleric","oath of the ancients paladin"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
	...
	},
	{
		...
		"subclasses": ["circle of the land (desert) druid","forge domain cleric","oath of the ancients paladin","oath of vengeance paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "necromancy",
		"classes": ["artificer", "cleric", "druid", "paladin", "ranger"],
		"subclasses": ["celestial warlock","grave domain cleric","life domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "conjuration",
		"classes": ["druid", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (arctic) druid","tempest domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "150 feet",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["bard", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (arctic) druid"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "120 feet",
	...
	},
	{
		...
		"higherLevelSlot": "The damage increases by 1d8 for each spell slot level above 3."
	},
	{
		"name": "Stinking Cloud",
		"level": 3,
		"school": "conjuration",
		"classes": ["bard", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (swamp) druid","fiend warlock"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "90 feet",
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["artificer", "druid", "ranger", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (coast) druid"],
		"actionType": "action",
		"concentration": false,
		"ritual": true,
		"range": "30 feet",
	...
	},
	{
		...
		"subclasses": ["circle of the land (coast) druid","circle of the land (swamp) druid"],
		"actionType": "action",
		"concentration": false,
		"ritual": true,
		"range": "30 feet",
	...
	},
	{
		...
		"higherLevelSlot": "You can target one additional creature for each spell slot level above 4."
	},
	{
		"name": "Blight",
		"level": 4,
		...
		"subclasses": ["circle of the land (desert) druid","grave domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "30 feet",
		...
		"higherLevelSlot": "The damage increases by 1d8 for each spell slot level above 4."
	},
	{
		"name": "Charm Monster",
		"level": 4,
	...
	},
	{
		...
		"school": "enchantment",
		"classes": ["bard", "druid", "sorcerer", "wizard"],
		"subclasses": ["great old one warlock","knowledge domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "90 feet",
		...
		"higherLevelSlot": "The Sphere's radius increases by 5 feet for each spell slot level above 4."
	},
	{
		...
		"higherLevelSlot": "The damage increases by 2d8 for each spell slot level above 4."
	},
	{
		...
		"higherLevelSlot": "The damage increases by 1d8 for each spell slot level above 5."
	},
	{
		"name": "Control Water",
		"level": 4,
		"school": "transmutation",
		"classes": ["cleric", "druid", "wizard"],
		"subclasses": ["circle of the land (coast) druid","tempest domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "300 feet",
	...
	},
	{
		...
		"school": "abjuration",
		"classes": ["cleric", "paladin"],
		"subclasses": ["grave domain cleric","life domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "conjuration",
		"classes": ["bard", "sorcerer", "warlock", "wizard"],
		"subclasses": ["oath of vengeance paladin","trickery domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "500 feet",
	...
	},
	{
		...
		"school": "divination",
		"classes": ["cleric", "druid", "wizard"],
		"subclasses": ["circle of the land (forest) druid","circle of the land (grassland) druid"],
		"actionType": "action",
		"concentration": false,
		"ritual": true,
		"range": "Self",
	...
	},
	{
		...
		"subclasses": ["archfey warlock","nature domain cleric","oath of conquest paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "60 feet",
		...
		"higherLevelSlot": "Your Concentration can last longer with a spell slot of level 5 (up to 10 minutes), 6 (up to 1 hour), or 7+ (up to 8 hours)."
	},
	{
	...
	},
	{
		...
		"school": "evocation",
		"classes": ["druid", "sorcerer", "wizard"],
		"subclasses": ["fiend warlock","armorer artificer"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
		...
		"duration": "10 minutes",
		"description": "Wispy flames wreathe your body for the duration, shedding Bright Light in a 10-foot radius and Dim Light for an additional 10 feet. The flames provide you with a warm shield or a chill shield, as you choose. The warm shield grants you Resistance to Cold damage, and the chill shield grants you Resistance to Fire damage. \n\nIn addition, whenever a creature within 5 feet of you hits you with a melee attack roll, the shield erupts with flame. The attacker takes 2d8 Fire damage from a warm shield or 2d8 Cold damage from a chill shield."
	},
	{
		...
		"subclasses": ["circle of the land (arctic) druid","circle of the land (coast) druid","circle of the land (forest) druid","circle of the land (grassland) druid","circle of the land (swamp) druid","oath of devotion paladin","war domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "illusion",
		"classes": ["bard", "sorcerer", "wizard"],
		"subclasses": ["archfey warlock","armorer artificer"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"school": "conjuration",
		"classes": ["cleric"],
		"subclasses": ["celestial warlock","life domain cleric","light domain cleric","oath of devotion paladin"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "30 feet",
	...
	},
	{
		...
		"school": "evocation",
		"classes": ["druid", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (arctic) druid","oath of the ancients paladin","tempest domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "300 feet",
		...
		"higherLevelSlot": "The Bludgeoning damage increases by 1d10 for each spell slot level above 4."
	},
	{
		"name": "Secret Chest",
		"level": 4,
	...
	},
	{
		...
		"higherLevelSlot": "You can increase the size of the Cube by 100 feet for each spell slot level above 4."
	},
	{
	...
	},
	{
		...
		"higherLevelSlot": "The damage increases by 1d10 for each spell slot level above 4."
	},
	{
		"name": "Polymorph",
		"level": 4,
	...
	},
	{
		...
		"school": "transmutation",
		"classes": ["artificer", "druid", "ranger", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (mountain) druid","oath of conquest paladin","oath of redemption paladin","oath of the ancients paladin","war domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Touch",
	...
	},
	{
		...
		"higherLevelSlot": "The initial damage increases by 2d4 for each spell slot level above 4."
	},
	{
		"name": "Wall of Fire",
		"level": 4,
		"school": "evocation",
		"classes": ["druid", "sorcerer", "wizard"],
		"subclasses": ["celestial warlock","fiend warlock","forge domain cleric","light domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "120 feet",
	...
	},
	{
		...
		"higherLevelSlot": "The creature's Slam damage increases by 1d4 (Medium or smaller), 1d6 (Large), or 1d12 (Huge) for each spell slot level above 5."
	},
	{
		"name": "Antilife Shell",
		"level": 5,
	...
	},
	{
		...
		"higherLevelSlot": "The damage of the Clenched Fist increases by 2d8 and the damage of the Grasping Hand increases by 2d6 for each spell slot level above 5."
	},
	{
		"name": "Cloudkill",
		"level": 5,
	...
	},
	{
		...
		"school": "divination",
		"classes": ["druid", "ranger"],
		"subclasses": ["circle of the land (arctic) druid","circle of the land (forest) druid","oath of the ancients paladin"],
		"actionType": "action",
		"concentration": false,
		"ritual": true,
		"castingTime": "1 minute",
	...
	},
	{
		...
		"school": "evocation",
		"classes": ["druid", "sorcerer", "wizard"],
		"subclasses": ["circle of the land (arctic) druid","hexblade warlock"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"higherLevelSlot": "The damage increases by 2d8 for each spell slot level above 5."
	},
	{
	...
	},
	{
		...
		"higherLevelSlot": "The Cube increases by 5 feet for each spell slot level above 5."
	},
	{
	...
	},
	{
		...
		"school": "enchantment",
		"classes": ["bard", "sorcerer", "wizard"],
		"subclasses": ["archfey warlock","oath of conquest paladin","trickery domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "60 feet",
		...
		"higherLevelSlot": "Your Concentration can last longer with a spell slot of level 6 (up to 10 minutes), 7 (up to 1 hour), or 8+ (up to 8 hours)."
	},
	{
		"name": "Dream",
		"level": 5,
	...
	},
	{
		...
		"school": "evocation",
		"classes": ["cleric"],
		"subclasses": ["celestial warlock","fiend warlock","light domain cleric","oath of devotion paladin","war domain cleric"],
		"actionType": "action",
		"concentration": false,
		"ritual": false,
		"range": "60 feet",
		...
		"higherLevelSlot": "The Fire damage and the Radiant damage increase by 1d6 for each spell slot level above 5."
	},
	{
		"name": "Geas",
		"level": 5,
		...
		"higherLevelSlot": "If you use a level 7 or 8 spell slot, the duration is 365 days. If you use a level 9 spell slot, the spell lasts until it is ended by one of the spells mentioned above."
	},
	{
	...
	},
	{
		...
		"school": "enchantment",
		"classes": ["bard", "sorcerer", "warlock", "wizard"],
		"subclasses": ["oath of redemption paladin","oath of vengeance paladin","war domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "90 feet",
		...
		"higherLevelSlot": "You can target one additional creature for each spell slot level above 5."
	},
	{
		"name": "Insect Plague",
		"level": 5,
		...
		"subclasses": ["circle of the land (desert) druid","circle of the land (grassland) druid","circle of the land (swamp) druid","nature domain cleric","tempest domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "300 feet",
		...
		"higherLevelSlot": "The damage increases by 1d10 for each spell slot level above 5."
	},
	{
		"name": "Legend Lore",
		"level": 5,
	...
	},
	{
		...
		"higherLevelSlot": "The healing increases by 1d8 for each spell slot level above 5."
	},
	{
		"name": "Mislead",
		"level": 5,
	...
	},
	{
		...
		"school": "enchantment",
		"classes": ["bard", "wizard"],
		"subclasses": ["great old one warlock","trickery domain cleric"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "30 feet",
		...
		"higherLevelSlot": "You can alter the target's memories of an event that took place up to 7 days ago (level 6 spell slot), 30 days ago (level 7 spell slot), 365 days ago (level 8 spell slot), or any time in the creature's past (level 9 spell slot)."
	},
	{
		"name": "Passwall",
		"level": 5,
	...
	},
	{
		...
		"higherLevelSlot": "The duration increases with a spell slot of level 6 (10 days), 7 (30 days), 8 (180 days), and 9 (366 days)."
	},
	{
		"name": "Raise Dead",
		"level": 5,
	...
	},
	{
		...
		"school": "divination",
		"classes": ["bard", "cleric", "druid", "warlock", "wizard"],
		"subclasses": ["circle of the land (coast) druid","circle of the land (swamp) druid","knowledge domain cleric","light domain cleric","oath of vengeance paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"castingTime": "10 minutes",
	...
	},
	{
		...
		"school": "conjuration",
		"classes": ["druid", "ranger"],
		"subclasses": ["circle of the land (forest) druid","nature domain cleric","oath of the ancients paladin"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "Self",
	...
	},
	{
		...
		"subclasses": ["circle of the land (desert) druid","circle of the land (mountain) druid"],
		"actionType": "action",
		"concentration": true,
		"ritual": false,
		"range": "120 feet",
	...
	},
	{
		...
		"higherLevelSlot": "One additional bolt leaps from the first target to another target for each spell slot level above 6."
	},
	{
		...
		"higherLevelSlot": "The damage increases by 2d8 for each spell slot level above 6."
	},
	{
		"name": "Conjure Fey",
		"level": 6,
		...
		"higherLevelSlot": "The damage increases by 2d12 for each spell slot level above 6."
	},
	{
		"name": "Contingency",
		"level": 6,
	...
	},
	{
		...
		"higherLevelSlot": "If you use a level 7 spell slot, you can animate or reassert control over four Ghouls. If you use a level 8 spell slot, you can animate or reassert control over five Ghouls or two Ghasts or Wights. If you use a level 9 spell slot, you can animate or reassert contro."
	},
	{
		"name": "Disintegrate",
		"level": 6,
		...
		"higherLevelSlot": "The damage increases by 3d6 for each spell slot level above 6."
	},
	{
	...
	},
	{
		...
		"higherLevelSlot": "The barrier blocks spells of 1 level higher for each spell slot level above 6."
	},
	{
	...
	},
	{
		...
		"higherLevelSlot": "The healing increases by 10 for each spell slot level above 6."
	},
	{
		"name": "Heroes' Feast",
		"level": 6,
	...
	},
	{
		...
		"higherLevelSlot": "The duration is longer with a spell slot of level 7 (10 days), 8 (30 days), or 9 (366 days)."
	},
	{
		"name": "Move Earth",
		"level": 6,
	...
	},
	{
		...
		"higherLevelSlot": "The damage increases by 1d6 for each slot level above 6."
	},
	{
	...
	},
	{
		...
		"higherLevelSlot": "The damage the wall deals when it appears increases by 2d6 and the damage from passing through the sheet of frigid air increases by 1d6 for each spell slot level above 6."
	},
	{
		"name": "Wall of Thorns",
		"level": 6,
		...
		"higherLevelSlot": "Both types of damage increase by 1d8 for each spell slot level above 6."
	},
	{
		"name": "Wind Walk",
		"level": 6,
	...
	},
	{
		...
		"higherLevelSlot": "The healing and damage increase by 1d12 for each spell slot level above 7."
	},
	{
		...
		"higherLevelSlot": "The base damage increases by 1d6 for each spell slot level above 7."
	},
	{
		"name": "Divine Word",
		"level": 7,
	...
	},
	{
		...
		"higherLevelSlot": "You can target up to three willing creatures (including yourself) for each spell slot level above 7. The creatures must be within 10 feet of you when you cast the spell."
	},
	{
...

	{
		...
		"actionType": "Bonus Action",
		"recharge": "long rest",
		"description": "On your turn you can enter a rage that lasts for 1 minute. While raging you have advantage on Strength checks and Strength saving throws, you gain a bonus to melee damage rolls using Strength (starts at +2, increases to +3 at level 9 and +4 at level 16), and you have resistance to bludgeoning, piercing, and slashing damage. Your rage ends early if you are knocked unconscious or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then. You can also end your rage on your turn as a bonus action. Once your rage ends you can't rage again until you finish a short or long rest. You can rage a limited number of times per long rest (2 at level 1, increasing to unlimited at level 20).",
		"upgrades": "Uses per long rest: 2 (lv1), 3 (lv3), 4 (lv6), 5 (lv12), 6 (lv17), Unlimited (lv20). Rage damage bonus: +2 (lv1), +3 (lv9), +4 (lv16)."
	},
	{
	...
	},
	{
		...
		"actionType": "passive",
		"recharge": "passive",
		"description": "You gain an uncanny sense of when things nearby aren't as they should be. You have advantage on Dexterity saving throws against effects that you can see, such as traps and spells. This benefit does not apply if you are Blinded, Deafened, or Incapacitated."
	},
	{
	...
	},
	{
		...
		"actionType": "passive",
		"recharge": "passive",
		"description": "At 20th level, you embody the power of the wilds. Your Strength score increases by 4, and your Constitution score increases by 4. Your maximum for those scores is now 24."
	},

	{
		...
		"actionType": "Bonus Action",
		"recharge": "long rest",
		"description": "You can inspire others through stirring words or music. To do so, you use a bonus action on your turn to choose one creature other than yourself within 60 feet of you who can hear you. That creature gains one Bardic Inspiration die, a d6. Once within the next 10 minutes, the creature can roll the die and add the number rolled to one ability check, attack roll, or saving throw it makes. The creature can wait until after it rolls the d20 before deciding to use the Bardic Inspiration die, but must decide before the DM says whether the roll succeeds or fails. A creature can have only one Bardic Inspiration die at a time. You can use this feature a number of times equal to your Charisma modifier (minimum once). You regain any expended uses when you finish a long rest.",
		"upgrades": "Die size: d6 (lv1–4), d8 (lv5–9), d10 (lv10–14), d12 (lv15–20). Font of Inspiration (lv5) allows regaining uses on short rest."
	},
	{
	...
	},
	{
		...
		"upgrades": "Extra healing: 1d6 (lv2–8), 1d8 (lv9–12), 1d10 (lv13–16), 1d12 (lv17–20)."
	},
	{
		"name": "Expertise (Bard)",
		"type": "class-ability",
...

	{
		...
		"actionType": "action",
		"recharge": "short rest",
		"description": "At 2nd level, you gain the ability to channel divine energy directly from your deity, using that energy to fuel magical effects. You start with two such effects: Turn Undead and an effect determined by your domain. Some domains grant you additional effects as you advance in levels. When you use your Channel Divinity, you choose which effect to create. You must then finish a short or long rest to use your Channel Divinity again. Some Channel Divinity effects require saving throws. When you use such an effect, the DC equals your cleric spell save DC. Beginning at 6th level, you can use your Channel Divinity twice between rests, and beginning at 18th level, you can use it three times."
	},
	{
		"name": "Turn Undead",
		"type": "class-ability",
	...
	},
	{
		...
		"actionType": "passive",
		"recharge": "passive",
		"description": "Starting at 5th level, when an undead fails its saving throw against your Turn Undead feature, the creature is instantly destroyed if its challenge rating is at or below a certain threshold: CR 1/2 (lv5), CR 1 (lv8), CR 2 (lv11), CR 3 (lv14), CR 4 (lv17)."
	},
	{
...

	{
		...
		"actionType": "action",
		"recharge": "short rest",
		"description": "Starting at 2nd level, you can use your action to magically assume the shape of a beast that you have seen before. You can use this feature twice per short or long rest. Your druid level determines the beasts you can transform into: CR 1/4 no swim speed (lv2), CR 1/2 no fly speed (lv4), CR 1 (lv8). You can stay in a beast shape for a number of hours equal to half your druid level (rounded down). You then revert to your normal form unless you expend another use of this feature. You revert sooner if you fall unconscious, drop to 0 hit points, or die. While in beast form you can't cast spells, can't speak, and lose the ability to take any action that requires hands. Your gear merges into your form. You retain your alignment, personality, and Intelligence, Wisdom, and Charisma scores."
	},
	{
	...
	},
	{
		...
		"upgrades": "1 use (lv2–16), 2 uses (lv17–20)."
	},
	{
		...
		"upgrades": "2 attacks (lv5), 3 attacks (lv11), 4 attacks (lv20)."
	},
	{
		"name": "Indomitable",
		"type": "class-ability",
		...
		"upgrades": "1 use (lv9–12), 2 uses (lv13–16), 3 uses (lv17–20)."
	},
	...
	{
		"name": "Great Weapon Fighting (Fighting Style)",
		"type": "class-ability",
...

	{
		...
		"actionType": "passive",
		"recharge": "passive",
		"description": "Your practice of martial arts gives you mastery of combat styles that use unarmed strikes and monk weapons. You gain the following benefits while you are unarmed or wielding only monk weapons and aren't wearing armor or wielding a shield: You can use Dexterity instead of Strength for attack and damage rolls. You can roll a d4 in place of the normal damage of your unarmed strike or monk weapon. You can roll this die even with a second attack made as a bonus action. When you use the Attack action with an unarmed strike or a monk weapon on your turn, you can make one unarmed strike as a bonus action.",
		"upgrades": "Martial Arts die: d4 (lv1–4), d6 (lv5–10), d8 (lv11–16), d10 (lv17–20)."
	},
	{
	...
	},
	{
		...
		"actionType": "passive",
		"recharge": "short rest",
		"description": "Starting at 2nd level, your training allows you to harness the mystic energy of ki. Your access to this energy is represented by a number of ki points equal to your monk level. You can spend these points to fuel various ki features. You start knowing three such features: Flurry of Blows, Patient Defense, and Step of the Wind. You learn more ki features as you gain levels in this class. When you spend a ki point, it is unavailable until you finish a short or long rest, at the end of which you draw all of your expended ki back into yourself.",
		"upgrades": "Ki points = monk level."
	},
	{
	...
	},
	{
		...
		"upgrades": "Damage: 2d8 (1st slot), 3d8 (2nd), 4d8 (3rd), 5d8 (4th+). +1d8 vs undead/fiends."
	},
	{
		"name": "Divine Health",
		"type": "class-ability",
	...
	},
	{
		...
		"actionType": "passive",
		"recharge": "passive",
		"description": "You are a master of navigating the natural world, and you react with swift and decisive action when attacked. Choose one type of favored terrain: arctic, coast, desert, forest, grassland, mountain, swamp, or the Underdark. When you make an Intelligence or Wisdom check related to your favored terrain, your proficiency bonus is doubled if you are using a skill that you're proficient in. While traveling through your favored terrain, your group can't become lost except by magical means, you remain alert to danger even when you are engaged in another activity, you can move stealthily at a normal pace, you find twice as much food when you forage, and when you travel alone, you can move at a fast pace while still using the Stealth skill."
	},
	{
...

	{
		...
		"upgrades": "Sneak Attack damage: 1d6 (lv1), +1d6 every 2 levels, up to 10d6 at level 19–20."
	},
	{
		"name": "Thieves' Cant",
		"type": "class-ability",
...

	{
		...
		"actionType": "passive",
		"recharge": "long rest",
		"description": "At 2nd level, you tap into a deep wellspring of magic within yourself. This wellspring is represented by sorcery points, which allow you to create a variety of magical effects. You have 2 sorcery points, and you gain one additional point every time you level up, for a total equal to your sorcerer level. You can never have more sorcery points than shown on the table for your level. You regain all spent sorcery points when you finish a long rest."
	},
	{
	...
	{
		"name": "Agonizing Blast (Invocation)",
		"type": "class-ability",
		"classes": ["warlock"],
		"levelGained": 2,
		"actionType": "passive",
		"recharge": "passive",
		"description": "Prerequisite: Eldritch Blast cantrip. When you cast Eldritch Blast, add your Charisma modifier to the damage it deals on a hit."
	},
	{
		"name": "Armor of Shadows (Invocation)",
		"type": "class-ability",
		"classes": ["warlock"],
		"levelGained": 2,
		"actionType": "passive",
	...
	{
		"name": "Mask of Many Faces (Invocation)",
		"type": "class-ability",
		"classes": ["warlock"],
		"levelGained": 2,
		"actionType": "passive",
	...
	{
		"name": "Repelling Blast (Invocation)",
		"type": "class-ability",
		"classes": ["warlock"],
		"levelGained": 2,
		"actionType": "passive",
		"recharge": "passive",
		"description": "Prerequisite: Eldritch Blast cantrip. When you hit a creature with Eldritch Blast, you can push the creature up to 10 feet away from you in a straight line."
	},
	{
		"name": "Pact of the Blade (Pact Boon)",
		"type": "class-ability",
		"classes": ["warlock"],
		"levelGained": 3,
		"actionType": "action",
	...
	{
		"name": "Pact of the Chain (Pact Boon)",
		"type": "class-ability",
		"classes": ["warlock"],
		"levelGained": 3,
		"actionType": "passive",
	...
	{
		"name": "Pact of the Tome (Pact Boon)",
		"type": "class-ability",
		"classes": ["warlock"],
		"levelGained": 3,
		"actionType": "passive",
		"recharge": "passive",
		"description": "Your patron gives you a grimoire called a Book of Shadows. When you gain this feature, choose three cantrips from any class's spell list. While the book is on your person, you can cast those cantrips at will. They don't count against your number of cantrips known. If they don't appear on the warlock spell list, they are nonetheless warlock spells for you. If you lose your Book of Shadows, you can perform a 1-hour ceremony to receive a replacement from your patron."
	},
	{
		"name": "Mystic Arcanum",
		"type": "class-ability",
		...
		"actionType": "passive",
		"recharge": "long rest",
		"description": "At 11th level, your patron bestows upon you a magical secret called an arcanum. Choose one 6th-level spell from the warlock spell list as this arcanum. You can cast your arcanum spell once without expending a spell slot. You must finish a long rest before you can do so again. At higher levels, you gain another warlock spell of your choice that can be cast in this way: a 7th-level spell at 13th level, an 8th-level spell at 15th level, and a 9th-level spell at 17th level. You regain all uses of your Mystic Arcanum when you finish a long rest."
	},
	{
...

	{
		"name": "Darkvision",
		"type": "racial-ability",
		"races": ["dwarf", "elf", "gnome", "half-elf", "half-orc", "tiefling", "dragonborn"],
		"levelGained": 1,
		"actionType": "passive",
		"recharge": "passive",
	...
	},
	{
		...
		"actionType": "passive",
		"recharge": "passive",
		"description": "You have draconic ancestry. Choose one type of dragon from the Draconic Ancestry table. Your breath weapon and damage resistance are determined by the dragon type, as shown in the table. Dragon types and their associated damage: Black (Acid), Blue (Lightning), Brass (Fire), Bronze (Lightning), Copper (Acid), Gold (Fire), Green (Poison), Red (Fire), Silver (Cold), White (Cold)."
	},
	{
		"name": "Breath Weapon",
		"type": "racial-ability",
	...
	},
	{
		...
		"actionType": "passive",
		"recharge": "passive",
		"description": "You have resistance to the damage type associated with your draconic ancestry (Acid, Lightning, Fire, Poison, or Cold, depending on dragon type)."
	},
	{
	...
	},
	{
		...
		"actionType": "passive",
		"recharge": "at will",
		"description": "You know the Minor Illusion cantrip. Intelligence is your spellcasting ability for it. (Forest/Rock Gnome variant)"
	},
	{
	...
	},
	{
		...
		"duration": "up to 1 minute",
		"description": "The next time you hit with a melee weapon attack during this spell's duration, your attack deals an extra 1d6 Necrotic damage. Additionally, if the target is a creature, it must succeed on a Wisdom saving throw or be frightened until the spell ends. As an action, the creature can make a Wisdom check against your spell save DC to steel its resolve and end this spell.",
		"higherLevelSlot": "The damage increases by 1d6 for each slot level above 1st."
	},
	{
		"name": "Branding Smite",
		"level": 2,
		...
		"higherLevelSlot": "The damage increases by 1d6 for each slot level above 2nd."
	},
	{
	...
	},
	{
		...
		"higherLevelSlot": "When you cast this spell using a spell slot of 5th or 6th level, the bonus to attack rolls increases to +2 and the extra damage increases to 2d4. When you use a spell slot of 7th level or higher, the bonus increases to +3 and the extra damage increases to 3d4."
	},
	{
		...
		"duration": "up to 1 minute",
		"description": "You open a gateway to the dark between the stars, a region infested with unknown horrors. A 20-foot-radius sphere of blackness and bitter cold appears, centered on a point with range and lasting for the duration. This void is filled with a cacophony of soft whispers and slurping noises that can be heard up to 30 feet away. No light, magical or otherwise, can illuminate the area, and creatures fully inside the area are blinded. \n\nThe void creates a warp in the fabric of space, and the area is difficult terrain. Any creature that starts its turn in the area takes 2d6 cold damage. Any creature that ends its turn in the area must succeed on a Dexterity saving throw or take 2d6 acid damage as milky, otherworldly tentacles rub against it."
	},
	{
	...
	},
	{
		...
		"higherLevelSlot": "The damage increases by 1d6 for each slot level above 4th."
	},
	{
	...
	},
	{
		...
		"cantripUpgrade": "At 5th level, the melee attack deals an extra 1d8 thunder damage to the target on a hit, and the damage the target takes for moving increases to 2d8. Both damage rolls increase by 1d8 at 11th level (2d8 and 3d8) and again at 17th level (3d8 and 4d8)."
	},
	{
		...
		"cantripUpgrade": "At 5th level, the melee attack deals an extra 1d8 fire damage to the target on a hit, and the fire damage to the second creature increases to 1d8 + your spellcasting ability modifier. Both damage rolls increase by 1d8 at 11th level (2d8 and 2d8) and 17th level (3d8 and 3d8)."
	},
	{
		"name": "Lightning Lure",
		"level": 0,
		...
		"cantripUpgrade": "This spell's damage increases by 1d8 when you reach 5th level (2d8), 11th level (3d8), and 17th level (4d8)."
	},
	{
		"name": "Mind Sliver",
		"level": 0,
		...
		"cantripUpgrade": "This spell's damage increases by 1d6 when you reach certain levels: 5th level (2d6), 11th level (3d6), and 17th level (4d6)."
	},
	{
		"name": "Sword Burst",
		"level": 0,
		...
		"cantripUpgrade": "This spell's damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6)."
	},
	{
		"name": "Toll the Dead",
		"level": 0,
		...
		"cantripUpgrade": "The spell's damage increases by one die when you reach 5th level (2d8 or 2d12), 11th level (3d8 or 3d12), and 17th level (4d8 or 4d12)."
	},
	{
		...
		"cantripUpgrade": "The spell's damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6)."
	},
	{
		"name": "Create Bonfire",
		"level": 0,
	...
	},
	{
		...
		"duration": "Instantaneous",
		"castingTime": "1 action",
		"description": "You create a burst of thunderous sound that can be heard up to 100 feet away. Each creature within 5 feet of you other than you must succeed on a Constitution saving throw or take 1d6 thunder damage.",
		"cantripUpgrade": "The spell's damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6)."
	},
	{
		"name": "Gust",
	...
	},
	{
		...
		"higherLevelSlot": "When you cast this spell using a spell slot of 2nd level or higher, the extra damage increases by 1d6 for each slot level above 1st."
	},
	{
		"name": "Cause Fear",
		"level": 1,
	...
	},
	{
		...
		"higherLevelSlot": "When you cast this spell using a 3rd- or 4th-level spell slot, the damage increases to 3d8. When you cast it using a 5th- or 6th-level spell slot, the damage increases to 4d8. When you cast it using a spell slot of 7th level or higher, the damage increases to 5d8."
	},
	{
		"name": "Healing Spirit",
		"level": 2,
		...
		"higherLevelSlot": "When you cast this spell using a spell slot of 3rd level or higher, the healing increases by 1d6 for each slot level above 2nd."
	},
	{
		"name": "Catnap",
		"level": 3,
	...
	},
	{
		...
		"higherLevelSlot": "When you cast this spell using a spell slot of 4th level or higher, the number of pieces of ammunition you can affect with this spell increases by two for each slot level above 3rd."
	},
	{
		"name": "Tiny Servant",
		"level": 3,
		...
		"higherLevelSlot": "When you cast this spell using a spell slot of 4th level or higher, you can animate two additional objects for each slot level above 3rd."
	},
	{
		...
		"higherLevelSlot": "When you cast this spell using a spell slot of 4th level or higher, use the higher level wherever the spell's level appears in the stat block."
	},
	{
...
export default SPELLS_AND_ABILITIES;