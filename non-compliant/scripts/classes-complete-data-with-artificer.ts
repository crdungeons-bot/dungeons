...
export const CLASSES_COMPLETE: ClassComplete[] = [
    ...
    // ═══════════════════════════════════════════════════════════
    {
        index: 'artificer',
        name: 'Artificer',
        sourcebook: 'ERLW',  // Eberron: Rising from the Last War
        hit_die: 8,
        hitPoints: {
            hitDie: 8,
            firstLevel: '8 + Constitution modifier',
            higherLevels: '1d8 (or 5) + Constitution modifier per Artificer level after 1st',
        },
        subclass_level: 3,
        ...
        saving_throws: [
            ...
            { index: 'saving-throw-int', name: 'Saving Throw: INT' },
        ],
        ...
        proficiencies: [
            ...
            { index: 'thieves-tools', name: "Thieves' Tools" },
            { index: 'tinkers-tools', name: "Tinker's Tools" },
        ],
        
        // Skill choices
        proficiency_choices: [
            {
                desc: 'Choose two from Arcana, History, Investigation, Medicine, Nature, Perception, or Sleight of Hand',
                choose: 2,
                type: 'skills',
                from: {
            ...
            },
            {
                ...
                from: {
                    option_set_type: 'options_array',
                    options: [
                        { option_type: 'reference', item: { index: 'alchemists-supplies', name: "Alchemist's Supplies" } },
                        { option_type: 'reference', item: { index: 'brewers-supplies', name: "Brewer's Supplies" } },
                        { option_type: 'reference', item: { index: 'calligraphers-supplies', name: "Calligrapher's Supplies" } },
                        { option_type: 'reference', item: { index: 'carpenters-tools', name: "Carpenter's Tools" } },
                        { option_type: 'reference', item: { index: 'cartographers-tools', name: "Cartographer's Tools" } },
                        { option_type: 'reference', item: { index: 'cobblers-tools', name: "Cobbler's Tools" } },
                        { option_type: 'reference', item: { index: 'cooks-utensils', name: "Cook's Utensils" } },
                        { option_type: 'reference', item: { index: 'glassblowers-tools', name: "Glassblower's Tools" } },
                        { option_type: 'reference', item: { index: 'jewelers-tools', name: "Jeweler's Tools" } },
                        { option_type: 'reference', item: { index: 'leatherworkers-tools', name: "Leatherworker's Tools" } },
                        { option_type: 'reference', item: { index: 'masons-tools', name: "Mason's Tools" } },
                        { option_type: 'reference', item: { index: 'painters-supplies', name: "Painter's Supplies" } },
                        { option_type: 'reference', item: { index: 'potters-tools', name: "Potter's Tools" } },
                        { option_type: 'reference', item: { index: 'smiths-tools', name: "Smith's Tools" } },
                        { option_type: 'reference', item: { index: 'weavers-tools', name: "Weaver's Tools" } },
                        { option_type: 'reference', item: { index: 'woodcarvers-tools', name: "Woodcarver's Tools" } },
                    ],
                },
            },
        ],
        ...
        // Starting equipment
        starting_equipment: [
            { equipment: { index: 'studded-leather-armor', name: 'Studded Leather Armor' }, quantity: 1 },
            { equipment: { index: 'dagger', name: 'Dagger' }, quantity: 2 },
            { equipment: { index: 'thieves-tools', name: "Thieves' Tools" }, quantity: 1 },
            { equipment: { index: 'tinkers-tools', name: "Tinker's Tools" }, quantity: 1 },
            { equipment: { index: 'dungeoneers-pack', name: "Dungeoneer's Pack" }, quantity: 1 },
        ],
        
        // Spellcasting progression (half caster)
        spellcasting: {
            type: 'half',
            ability: 'int',
            prepareSpells: true,
            preparedSpellsFormula: 'artificer_level / 2 (rounded up) + intelligence_modifier',
            cantripsKnownPerLevel: {
                1: 2, 2: 2, 3: 2, 4: 2, 5: 2, 6: 2, 7: 2, 8: 2, 9: 2,
                10: 3, 11: 3, 12: 3, 13: 3, 14: 4, 15: 4, 16: 4, 17: 4, 18: 4, 19: 4, 20: 4,
            },
            spellsKnownPerLevel: {
        ...
        resources: [
            {
                name: 'Infused Items',
                type: 'other',
                usesPerRest: '2 at level 2, increases at higher levels',
                restType: 'long',
                levelGained: 2,
                description: 'Number of magic items you can have infused at once',
            },
        ],
            ...
            1: [
                {
                    ...
                    level: 1,
                    description: 'At 1st level, you learn how to invest a spark of magic into mundane objects. To use this ability, you must have thieves\' tools or artisan\'s tools in hand. You then touch a Tiny nonmagical object as an action and give it one of the following magical properties of your choice:\n\n• The object sheds bright light in a 5-foot radius and dim light for an additional 5 feet.\n• Whenever tapped by a creature, the object emits a recorded message that can be heard up to 10 feet away. You utter the message when you bestow this property on the object, and the recording can be no more than 6 seconds long.\n• The object continuously emits your choice of an odor or a nonverbal sound (wind, waves, chirping, or the like). The chosen phenomenon is perceivable up to 10 feet away.\n• A static visual effect appears on one of the object\'s surfaces. This effect can be a picture, up to 25 words of text, lines and shapes, or a mixture of these elements, as you like.\n\nThe chosen property lasts indefinitely. As an action, you can touch the object and end the property early.\n\nYou can bestow magic on multiple objects, touching one object each time you use this feature, though a single object can only bear one property at a time. The maximum number of objects you can affect with this feature at one time is equal to your Intelligence modifier (minimum of one object). If you try to exceed your maximum, the oldest property immediately ends, and then the new property applies.',
                    actionType: 'action',
                },
                {
                    name: 'Spellcasting',
                    level: 1,
                    description: 'You have studied the workings of magic and how to channel it through objects. As a result, you have gained the ability to cast spells. See chapter 10 for the general rules of spellcasting and chapter 3 for the artificer spell list.\n\nCantrips: You know two cantrips of your choice from the artificer spell list. At higher levels, you learn additional artificer cantrips of your choice, as shown in the Cantrips Known column of the Artificer table.\n\nPreparing and Casting Spells: The Artificer table shows how many spell slots you have to cast your artificer spells. To cast one of your artificer spells of 1st level or higher, you must expend a slot of the spell\'s level or higher. You regain all expended spell slots when you finish a long rest.\n\nYou prepare the list of artificer spells that are available for you to cast, choosing from the artificer spell list. When you do so, choose a number of artificer spells equal to your Intelligence modifier + half your artificer level, rounded down (minimum of one spell). The spells must be of a level for which you have spell slots.\n\nSpellcasting Focus: You produce your artificer spell effects through your tools. You must have a spellcasting focus, specifically thieves\' tools or some kind of artisan\'s tool, in hand when you cast any spell with this Spellcasting feature. You must be proficient with the tool to use it in this way.',
                    actionType: 'special',
                },
            ],
            2: [
            ...
            3: [
                {
                    ...
                    level: 3,
                    description: 'At 3rd level, you choose the type of specialist you are: Alchemist, Armorer, Artillerist, or Battle Smith, each of which is detailed at the end of the class\'s description. Your choice grants you features at 5th level and again at 9th and 15th level.',
                    actionType: 'special',
                },
                {
                    name: 'The Right Tool for the Job',
                    level: 3,
                    description: 'At 3rd level, you learn how to produce exactly the tool you need: with thieves\' tools or artisan\'s tools in hand, you can magically create one set of artisan\'s tools in an unoccupied space within 5 feet of you. This creation requires 1 hour of uninterrupted work, which can coincide with a short or long rest. Though the product of magic, the tools are nonmagical, and they vanish when you use this feature again.',
                    actionType: 'special',
                },
            ],
            4: [
            ...
            5: [
                {
                    ...
                    level: 5,
                    description: 'At 5th level, you gain a feature granted by your Artificer Specialist choice.',
                    actionType: 'special',
                },
            ],
            6: [
            ...
            9: [
                {
                    name: 'Artificer Specialist Feature',
                    level: 9,
                    description: 'At 9th level, you gain a feature granted by your Artificer Specialist choice.',
                    actionType: 'special',
                },
            ],
            10: [
            ...
            11: [
                {
                    ...
                    level: 11,
                    description: 'At 11th level, you learn how to store a spell in an object. Whenever you finish a long rest, you can touch one simple or martial weapon or one item that you can use as a spellcasting focus, and you store a spell in it, choosing a 1st- or 2nd-level spell from the artificer spell list that requires 1 action to cast (you needn\'t have it prepared).\n\nWhile holding the object, a creature can take an action to produce the spell\'s effect from it, using your spellcasting ability modifier. If the spell requires concentration, the creature must concentrate. The spell stays in the object until it\'s been used a number of times equal to twice your Intelligence modifier (minimum of twice) or until you use this feature again to store a spell in an object.',
                    actionType: 'special',
                },
            ],
            12: [
            ...
            15: [
                {
                    name: 'Artificer Specialist Feature',
                    level: 15,
                    description: 'At 15th level, you gain a feature granted by your Artificer Specialist choice.',
                    actionType: 'special',
                },
            ],
            16: [
            ...
            18: [
                {
                    ...
                    level: 18,
                    description: 'Starting at 18th level, you can attune to up to six magic items at once.',
                    actionType: 'passive',
                },
            ],
            19: [
